FactoryGirl.define do
  factory :transfer_in do
    ...
    factory :new_transfer, traits: [:new, :unreconciled, :created_now]
    factory :error_transfer, traits: [:new, :error, :created_aweekago]
    factory :reconciled_transfer, traits: [:sent, :reconciled, :created_amonthage]
    factory :unreconciled_transfer, traits: [:sent, :unreconciled, :created_aweekago]
